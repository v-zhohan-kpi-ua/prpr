// https://github.com/shadcn-ui/ui/pull/1680
...
import { buttonVariants } from "@prpr/ui/components/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: "flex gap-1 grow dropdowns",
        dropdown_month: cn(
          props.captionLayout === "dropdown" &&
            "w-[60%] justify-between px-2 py-4"
        ),
        dropdown_year: cn(
          props.captionLayout === "dropdown" &&
            "w-[40%] justify-between px-2 py-4"
        ),
